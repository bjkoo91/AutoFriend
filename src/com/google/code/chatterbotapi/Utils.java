...
class Utils {
    ...
    public static String post(String url, Map<String, String> parameters) throws Exception {
    	ConnectionTask t = new Utils().new ConnectionTask();
        Input in = new Utils().new Input(url, parameters);
        return t.execute(in).get();
    }
    ...
    protected class Input {
        ...
        public Input(String _url, Map<String, String> _parameters) {
            url = _url;
            parameters = _parameters;
        }
    }
    
    protected class ConnectionTask extends AsyncTask<Input, Void, String> {
    	@Override
        protected String doInBackground(Input... inputs) {
            try {
                Input in = inputs[0];
                String url = in.url;
                Map<String, String> parameters = in.parameters;
            	...
            	Log.e("ConnectionTask", "connection task problem", e);
            	return null;
            }
        }
    }
